...
Zitsraa.sendMessage(from,fs.readFileSync(`./assets/peler.jpg`), image, {caption: help(prefix), quoted: fgclink,sendEphemeral: true,text,contextInfo: { forwardingScore: 945, isForwarded: true }})
break
case 'virgam':
...
sendButLocation(from, help(prefix), `DVNSKI BOT 
...
case 'unblock':
  Zitsraa.updatePresence(from, Presence.composing)
  if (!isGroup) return reply(mess.only.group)
  Zitsraa.blockUser (`${body.slice(8)}@c.us`, "remove")
